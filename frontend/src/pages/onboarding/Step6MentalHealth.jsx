  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
      <div className="space-y-2">
        ...
        <p className="text-gray-400 text-sm">A brief screening for stress, anxiety, and mood. All data is strictly confidential.</p>
      </div>
      ...
      <div className="grid gap-4">
        {[
          ...
          >
            <div className={`p-2 rounded-xl mr-4 ${formData[item.id] ? 'bg-emerald-500 text-white' : 'bg-gray-800 text-gray-500'}`}>
