      ...
      <div className="flex justify-between items-end mb-8">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <button 
            onClick={generateReport}
            disabled={generating}
            className="px-4 py-2 bg-gray-900 border border-gray-800 hover:border-emerald-500 hover:text-emerald-400 rounded-lg text-sm font-medium transition-colors flex items-center text-gray-300 disabled:opacity-50 shadow-xl"
          >
